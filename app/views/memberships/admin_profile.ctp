...
$(document).ready(function(){
 ...
 $('#bank option:selected').attr('disabled',true);
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr valign="top">
    ...
    <td>
     ...
     <?php echo $form->error('Member.member_id'); ?>  
  ...
  <tr valign="top">
    ...
    <td>
     ...
     <?php echo $form->error('Member.new_ic_num'); ?>  
  ...
  <tr><td>&nbsp;</td></tr>
   ...
   <tr valign="top">
    ...
    <td>
     ...
     <select name="data[Member][nationality_id]" id="nationality">
     ...
     <?php echo $form->error('Member.nationality_id'); ?>   
  ...
  <tr><td>&nbsp;</td></tr>
    ...
    <td> 
      ...
      echo '<input type="text" name="data[Member][race_text]" id="race_text" value="'.@ucwords($data['Member']['race_text']).'" />';
 ...
 ?>
  ...
  <tr valign="top">
    ...
    <td valign="top">
     ...
     <?php echo $form->error('Member.contact_number_house'); ?>&nbsp;(HSE) 
  ...
  <tr valign="top">
    ...
    <td valign="top">
     ...
     <?php echo $form->error('Member.contact_number_hp'); ?>  
  ...
  <tr valign="top">
    ...
    <?php echo $form->error('Member.spouse_name'); ?>   
  ...
  <tr valign="top">
    ...
    <?php echo $form->error('Member.spouse_ic_num'); ?>  
  ...
  <tr valign="top">
    ...
    <td>
     ...
     <?php echo $form->error('Member.beneficiary_name'); ?>  
  ...
  <tr valign="top">
    ...
    <td>
     ...
     <?php echo $form->error('Member.beneficiary_ic_num'); ?>    
  ...
  <tr valign="top">
    ...
    <?php echo $form->error('Member.beneficiary_relationship'); ?> 
  ...
  <tr valign="top">
    ...
    <td>
     ...
     <?php echo $form->error('Member.beneficiary_address');?>
  ...
  <tr valign="top">
    ...
    <td>
     ...
     <?php echo $form->error('Member.beneficiary_number_house'); ?>
  ...
  <tr valign="top">
    ...
    <td>
     ...
     <?php echo $form->error('Member.beneficiary_number_hp'); ?>   
  ...
  <tr valign="top">
    ...
    <?php
...

     {
      ...
      <select name="data[Member][bank_id]" id="bank">
     ...
     <?php echo $form->error('Member.bank_id'); ?>   
  ...
  <tr valign="top">
    ...
    <td>
     ...
     <?php echo $form->error('Member.bank_account_num'); ?> 
  ...
  <tr valign="top">
    ...
    <td> 
       ...
       echo $form->error('Member.sponsor_member_id');
