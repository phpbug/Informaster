<?php echo $form->create('Pioneer',array('action'=>'registration')); ?>
<dl>
  <dt>Email : </dt>
  <dd>
  <?php
   echo $form->text('Pioneer.username',array('div' => false , 'label' => false , 'maxlength'=>50 , 'value' => @$data['Pioneer']['username']));
  ?>  
  ...
  <div class="hintz">* The min is length of 5 and max length for the password is only 10</div>
